 <div class="row tab-douong-replace">
    <?php
    $total = 0;
    $paged = 1;
    $args = array(
...
<?php if($total > 0) { ?>
    ...
    <nav class="main-pagination monanngon-douong">
        <ul class="pagination">

            <li class="page-item monanngon-douong-page-item" index="1">
            ...
            <?php for($i = 0; $i < $total; $i++) { ?>
                <li class="page-item monanngon-douong-page-item monanngon-douong-page-item-<?php echo $i + 1 ?> <?php if($i==0) {echo "active";} ?>"
                    index="<?php echo $i + 1 ?>">
                    <a class="page-link" href="javascript:void(0)"><?php echo $i+1 ?></a></li>
                <?php } ?>

                <li class="page-item monanngon-douong-page-item" 
